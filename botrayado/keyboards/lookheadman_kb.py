...
GROUP_BUTTONS_BFI_PAYLOAD: list = [{"group_button_h": "bfi2101"}, {"group_button_h": "bfi2102"}]
GROUP_BUTTONS_BVT_PAYLOAD: list = [{"group_button_h": "bvt2101"}, {"group_button_h": "bvt2102"}, {"group_button_h": "bvt2103"}, {
    "group_button_h": "bvt2104"}, {"group_button_h": "bvt2105"}, {"group_button_h": "bvt2106"}, {"group_button_h": "bvt2107"}, {"group_button_h": "bvt2108"}]
GROUP_BUTTONS_BST_PAYLOAD: list = [{"group_button_h": "bst2101"}, {"group_button_h": "bst2102"}, {"group_button_h": "bst2103"}, {"group_button_h": "bst2104"}, {"group_button_h": "bst2105"}, {"group_button_h": "bst2106"}]
GROUP_BUTTONS_BEI_PAYLOAD: list = [{"group_button_h": 'bei2101'}, {"group_button_h": 'bei2102'}, {"group_button_h": 'bei2103'}]
GROUP_BUTTONS_BIB_PAYLOAD: list = [{"group_button_h": 'bib2101'}, {"group_button_h": 'bib2102'}, {"group_button_h": 'bib2103'}, {"group_button_h": 'bib2104'}]
GROUP_BUTTONS_BMP_PAYLOAD: list = [{"group_button_h": "bmp2101"}]
GROUP_BUTTONS_ZRC_PAYLOAD: list = [{"group_button_h": 'zrc2101'}, {"group_button_h": 'zrc2102'}]
GROUP_BUTTONS_BAP_PAYLOAD: list = [{"group_button_h": 'bap2101'}]
GROUP_BUTTONS_BEE_PAYLOAD: list = [{"group_button_h": 'bee2101'}]
GROUP_BUTTONS_BBI_PAYLOAD: list = [{"group_button_h": 'bbi2101'}]
GROUP_BUTTONS_BER_PAYLOAD: list = [{"group_button_h": 'ber2101'}]
GROUP_BUTTONS_BUT_PAYLOAD: list = [{"group_button_h": "but2101"}, {"group_button_h": "but2102"}, {"group_button_h": "but2103"}]
GROUP_BUTTONS_BRT_PAYLOAD: list = [{"group_button_h": 'brt2101'}, {"group_button_h": 'brt2102'}]
GROUP_BUTTONS_BIK_PAYLOAD: list = [{"group_button_h": "bik2101"}, {"group_button_h": "bik2102"}, {"group_button_h": "bik2103"}, {
    "group_button_h": "bik2104"}, {"group_button_h": "bik2105"}, {"group_button_h": "bik2106"}, {"group_button_h": "bik2107"}, {"group_button_h": "bik2108"},
    {"group_button_h": "bik2109"}]
GROUP_BUTTONS_BIN_PAYLOAD: list = [{"group_button_h": "bin2101"}, {"group_button_h": "bin2102"}, {"group_button_h": "bin2103"}, {
    "group_button_h": "bin2104"}, {"group_button_h": "bin2105"}, {"group_button_h": "bin2106"}, {"group_button_h": "bin2107"}, {"group_button_h": "bin2108"},
    {"group_button_h": "bin2109"}, {"group_button_h": "bin2110"}]

# Payload кнопок для факультетов
FACULTIES_BUTTONS_PAYLOAD: list = [{"faculty_button_h": "it"}, {"faculty_button_h": "kiib"}, {"faculty_button_h": "rit"}, {"faculty_button_h": "tseimk"}, {"faculty_button_h": "siss"}]

# Payload кнопок для потоков
STREAM_IT_BUTTONS_PAYLOAD: list = [{'stream_button_h': 'бфи'}, {'stream_button_h': 'бвт'}, {'stream_button_h': 'бст'}, {'stream_button_h': 'бэи'}]
STREAM_TSEIMK_BUTTONS_PAYLOAD: list = [{'stream_button_h': 'бээ'}, {'stream_button_h': 'бэр'}, {'stream_button_h': 'бби'}]
STREAM_KIIB_BUTTONS_PAYLOAD: list = [{'stream_button_h': 'бап'}, {'stream_button_h': 'бмп'}, {'stream_button_h': 'бут'}, {'stream_button_h': 'зрс'}, {'stream_button_h': 'биб'}]
STREAM_RIT_BUTTONS_PAYLOAD: list = [{'stream_button_h': 'брт'}, {'stream_button_h': 'бик'}]
STREAM_SISS_BUTTONS_PAYLOAD: list = [{'stream_button_h': 'бин'}]
